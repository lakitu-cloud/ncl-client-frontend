...
<section className="w-full max-w-full">
  <div className="bg-white rounded-sm border border-gray-200 shadow-sm p-8 dark:bg-darkTheme dark:text-whiteText dark:border-gray-400">
    {/* Header: Title + Icon */}
    <div className="flex items-center justify-between mb-4 border-b-2 pb-4 font-oswald">
      <h2 className="text-xl font-semibold uppercase text-gray-900 dark:text-gray-300">
        Quick Access Metrics
      </h2>
      <GridIcon aria-hidden="true" />
    </div>

    {/* 2 Rows × 4 Cards Grid – Exact visual match */}
    <div className="grid grid-cols-4 gap-8">
      {quickAccessItems.map((item, idx) => (
        <div
          key={idx} // using stable id instead of index
          className="flex items-center gap-1" // 4px = gap-1 in Tailwind
        >
          ...
          <div className="ml-3 flex flex-col">
            <span className="text-sm font-medium uppercase leading-tight text-gray-600 dark:text-gray-400 font-oswald">
              {item.label}
            </span>
            <span className="mt-0.5 text-lg font-bold text-gray-900 dark:text-white font-oswald">
              TZS {item.value.toLocaleString()} {/* proper number formatting */}
            </span>
          </div>
        </div>
      ))}
      ...
      <section className="w-full max-w-full grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Pie Chart */}
        <div className="bg-white rounded-sm shadow-sm p-6 border border-gray-250 dark:bg-darkTheme dark:border-gray-400 dark:text-gray-200">
        

          {/* Title + Icon */}
          <div className="flex justify-between items-center mb-4 border-b-2 font-oswald">
            <h2 className="text-xl font-semibold text-gray-900 mb-2 uppercase dark:text-whiteText">Managers Distribution</h2>
            <PieIcon />
          </div>
        ...
        {/* Bar Chart */}
        <div className="bg-white rounded-sm shadow-sm p-6 border border-gray-250 dark:bg-darkTheme dark:text-whiteText dark:border-gray-400">
           <div className="flex justify-between items-center mb-4 border-b-2 font-oswald">
            <h2 className="text-xl font-semibold text-gray-900 mb-2 uppercase dark:text-gray-200">Performance</h2>
            <RankIcon />
          </div>
