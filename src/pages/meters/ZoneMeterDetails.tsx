...
import TokenActionsModal from "../../components/modal/tokenModal";
import TokenTable from "./TokenTable";
import ReportProblemModal from "../../components/modal/reportProblem";
...
export default function ZoneMeterDetailPage() {
      ...
      <div className="flex items-center justify-center h-screen bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-600">
            {(error as any)?.message || "Meter not found"}
          </p>
        </div>
      </div>
    );
  ...
  const totalRevenue = meter.transactions.reduce(
      ...
      <div className="flex h-screen ">
          ...
          <div className="p-6">
            ...
            <motion.div 
              ...
              <div className="relative w-full h-56">
                ...
                <img
                  src={
                    meter.image || require("../../assets/images/products/1.png")
                  }
                  alt="Water Meter"
            ...
            {/* General Information */}
            <h3 className="text-lg font-semibold text-gray-800 mb-8 dark:text-whiteText uppercase font-oswald">
              GENERAL INFORMATION
            </h3>
            <div className="space-y-4 text-sm font-poppins">
              <div className="flex justify-between items-center ">
                <span className="text-gray-600 dark:text-whiteText font-semibold">
                  Serial Number
                </span>
                <div className="flex items-center gap-2">
                  <span className="font-bold text-gray-900 dark:text-whiteText">
                    {meter.serial}
                  </span>
                  <button
              ...
              <div className="flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  <span className="font-poppins text-xs px-2 py-1 ">
                    {meter.description.slice(6)}
                  </span>
                  {/* <button
              ...
              <div className="flex justify-between items-center">
                ...
                <span
                  className={`px-3 py-1 rounded-md text-xs dark:bg-blackText dark:border dark:border-gray-700 font-medium ${meter.lock ? "bg-red-100 text-red-800" : "bg-green-100  text-green-800"}`}
                >
            ...
            {/* Performance Summary */}
            <h3 className="text-lg font-semibold text-blackText mb-8 font-oswald uppercase dark:text-whiteText">
              PERFORMANCE REPORT
            </h3>
            <div className="space-y-4 text-sm font-poppins dark:text-whiteText">
              <div className="flex justify-between">
                ...
                <span className="font-bold text-green-600 text-md">
                  TSH <CountUp value={Number(totalRevenue ?? 0)} />
                </span>
              </div>
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-900 dark:text-whiteText ">
                  <CountUp value={Number(totalVolume.toFixed(1))} /> m³
                </span>
              </div>
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium"><CountUp value={Number(meter.transactions.length)} /></span>
              </div>
            </div>
          </div>
        </motion.div>
          ...
          <div className="max-w-auto dark:text-whiteText">
            <div>
              <div className="flex mb-8 justify-between items-center px-4">
                <div>
                  <h2 className="text-2xl font-bold text-blackText dark:text-whiteText font-oswald">
                    Meter Details
                  </h2>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    ...
                    className="p-3 bg-white border border-gray-300 rounded-md hover:bg-gray-50 transition"
                    title="Generate Token / Clear Tamper"
                  >
                    <GiToken className="w-4 h-4 text-gray-600" />
                  </button>

                  <button
                    onClick={() => setIsReportProblemOpen(true)}
                    className="p-3 bg-white border border-gray-300 rounded-md hover:bg-gray-50 transition"
                    title="Report Meter Problem"
                  >
            ...
            <div className="dark:bg-blackText dark:text-whiteText text-blackText rounded-md shadow-sm border border-gray-200 dark:border-gray-700 p-6 mb-8">
              <h3 className="text-lg font-medium font-oswald mb-4">
              ...
              {manager ? (
                <div className="flex items-center gap-5 font-poppins">
                  ...
                  <div>
                    <p className="font-medium text-blackText dark:text-whiteText">
                      {manager.name}
                    </p>
                    <p className="text-sm text-gray-500">Sales Officer</p>
                  </div>
                </div>
              ) : (
              ...
              <motion.div
                ...
                {activeTab === "transactions" && (
                  <div>
                    <div className="py-4 flex justify-between items-center">
                      <h3 className="text-md font-medium text-gray-800 dark:text-whiteText font-oswald">
                      ...
                      <table className="w-full rounded-md shadow-sm border border-gray-200 dark:bg-blackText dark:border-gray-700 overflow-hidden">
                        ...
                        <tbody className="divide-y divide-gray-200">
                          {meter.transactions.map((tx) => (
                            <tr
                              key={tx.id}
                              className="hover:bg-gray-50 dark:hover:bg-darkTheme transition"
                            >
                ...
                {activeTab === "configurations" && (
                  <div className="space-y-6">
                    ...
                    <div className="py-4 flex justify-between items-center">
                      <h3 className="text-md font-medium text-gray-800 dark:text-whiteText font-oswald">
                        Meter Configurations / Jobs
                      </h3>
                      <span className="text-sm font-medium text-gray-600 dark:text-gray-400">
                        {meter.jobs?.length || 0} configuration{meter.jobs?.length !== 1 ? "s" : ""}
                      </span>
                    </div>

                    {/* Empty State */}
                    {!meter.jobs || meter.jobs.length === 0 ? (
                      <div className="text-center py-16 bg-gray-50 dark:bg-gray-900 rounded-xl border border-dashed border-gray-300 dark:border-gray-700">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-500 mt-2">
                          This meter has no pending or completed jobs yet.
                        </p>
                      </div>
                    ) : (
                            ...
                            {meter.jobs.map((job) => (
                              ...
                              >
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">
                                  <span
                                    className={`inline-flex px-3 py-1 rounded-full text-xs font-medium ${job.status === "pending"
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                  {format(new Date(job.updatedAt), "dd MMM yyyy, HH:mm")}
                                </td>
                                <td className="px-6 py-4 whitespace-nowrap text-center">
                                  {job.status === "pending" && (
                                    <button
                                      onClick={() => {
                                        // TODO: Implement cancel job mutation
                                        if (window.confirm("Cancel this pending job?")) {
        ...
        {isReportProblemOpen && meter && (
          <ReportProblemModal
            ...
            meterSerial={meter.serial}
            onSuccess={() => {
              // Optional: refresh meter data or show success message
              toast.success("Problem report sent to manufacturer");
            }}
          />
        )}
      </div>
